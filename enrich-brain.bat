@echo off
REM =============================================================
REM enrich-brain.bat — Carga arquitectura de referencia KLAP BYSF
REM Ejecutar DESPUES de init-brain.bat
...
echo {"statements":[{"statement":"MERGE (s:Entity {name: 'Standard KLAP BYSF', entityType: 'Standard'}) SET s.version = '1.2.0', s.description = 'Arquitectura de referencia para microservicios KLAP BYSF', s.updatedAt = datetime(), s.team = 'Liquidacion SVBO'"}]} > "%TMP%"
call :RUN "Nodo Standard KLAP BYSF"

REM =============================================================
echo [2/8] Stack tecnologico...

echo {"statements":[{"statement":"MERGE (s:Entity {name: 'Stack Tecnologico', entityType: 'Stack'}) SET s.java = 'Java 21', s.gradle = 'Gradle 9.0.0', s.springBoot = 'Spring Boot 3.5.11', s.springCloud = 'Spring Cloud 2025.0.0', s.createdAt = datetime()"}]} > "%TMP%"
call :RUN "Stack base"
...
echo {"statements":[{"statement":"MERGE (d:Entity {name: 'Dependencias Principales', entityType: 'Dependencies'}) SET d.web = 'spring-boot-starter-web', d.actuator = 'spring-boot-starter-actuator', d.validation = 'spring-boot-starter-validation', d.kafka = 'spring-kafka', d.jdbc = 'spring-boot-starter-jdbc', d.postgresql = 'postgresql:42.7.2', d.openapi = 'springdoc-openapi-starter-webmvc-ui:2.8.12', d.webflux = 'spring-webflux (solo cliente)', d.resilience4j = 'resilience4j-spring-boot3:2.2.0', d.lombok = 'lombok (compile only)', d.logback = 'logback-awslogs-appender:1.6.0'"}]} > "%TMP%"
call :RUN "Dependencias"
...
call :RUN "Estructura de paquetes"
